      ...
      <div className="left">
        {showLogin ? (
          ...
          <div className="container login-container">
            ...
            <p>A Self-Assessment Tool for ICT Students</p>
            ...
            <form className="login-form" onSubmit={handleAuthSubmit}>
              ...
              <input type="text" className="input username" placeholder="e.g. Juan Dela Cruz" required />
          ...
          <div className="container register-container">
            ...
            <form className="login-form" onSubmit={handleAuthSubmit}>
              ...
              <input type="text" className="input" placeholder="e.g. Juan Dela Cruz" required />
              <label>Username</label>
      ...
      <div className="right">
        ...
        <div className="quote">
          <h2 className="qoute-text">
            "Understanding your programming journey is the first step to mastering it."
          </h2>
